...
void TermsPage::showEvent(QShowEvent *event) {
  ...
  QLabel *title = new QLabel(tr("الأحكام والشروط"));
  ...
  QPushButton *decline_btn = new QPushButton(tr("رفض"));
  buttons->addWidget(decline_btn);
  QObject::connect(decline_btn, &QPushButton::clicked, this, &TermsPage::declinedTerms);

  accept_btn = new QPushButton(tr("قم بالتمرير للقبول"));
...
void DeclinePage::showEvent(QShowEvent *event) {
  ...
  text->setText(tr("يجب عليك قبول الشروط والأحكام من أجل استخدام القائد الآلي."));
  ...
  QPushButton *back_btn = new QPushButton(tr("الخلف"));
